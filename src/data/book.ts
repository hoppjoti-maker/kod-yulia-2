...
export const BOOK = {
  ...
  edition: "Том II",
  subtitle:
    "Пятнадцать глав. Шкала раны W0–W3. Голос пакета. Плотность, не хронометраж. Внутри не ноль.",
  formula:
    "Не инвентарь. Не марафон на пятнадцать часов. Канал, жест, «нет». Рот ещё её.",
